...
It's not recursive. It is not greedy because it does not pick the best option at each step, it instead waits to consider all options. It is doing top down dynamic programming, because it is looking at all canidates then chosing the best.
