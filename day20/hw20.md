...
Yes, it will alway terminate. It's in NP as the solution can be checked in polynomial time. It's also in NP hard, it's at least as hard as every problem in NP.
